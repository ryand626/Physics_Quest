...
//To use Pan Gesture, just attach some kind of Collider (Box Collider, Sphere Collider, etc.) to a game object, along
//with the TouchScript "Pan Gesture" and "Transformer2D" components.
...
public class ftlPan : ftlManager
{
