...
//To use Rotate Gesture, just attach some kind of Collider (Box Collider, Sphere Collider, etc.) to a game object, along
//with the TouchScript "Rotate Gesture" and "Transformer2D" components.
...
public class ftlRotate : ftlManager
{
